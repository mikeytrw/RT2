project "RT2ImGuiProbe"
   ...
   cppdialect "C++17"
    ...
    -- T8: PhysicsDebugLines.cpp + PhysicsDebugCapture.cpp are CPU-only and
    -- ride this closure; PhysicsDebugOverlay.cpp (ImGui) never does.
    ...
    -- T8 CPU-only debug DTO + capture (overlay stays RT2App-only).
